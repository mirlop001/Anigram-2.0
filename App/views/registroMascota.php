    ...
    <form method="post" id="Reg_mascota" action="../controllers/registroMascota_controller.php">
        ...
        <div class="col-md-2"  >
            <label for="foto-perfil perfil-md">
                <div id="foto-mascota" class="foto-perfil perfil-md subir-foto" style="background-image:url('/Anigram/Desarrollo/img/IMG_0547.jpg')"></div>
            </label>
		</div>
        ...
        <div id="boton_enviar">
            <input id="submit" type="submit" name="submit" class="submitHueso" value="Añadir"/>	
        </div>
