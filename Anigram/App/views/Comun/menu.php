...
<nav class="navbar navbar-expand-lg navbar-light bg-light" id="menu-lateral">
    <a class="navbar-item" href="#"><img class="perfil-pe " src=<?php  if(isset($_SESSION['fotoPerfilUsuario'])) { echo '../../public/img/saved/'.$_SESSION['fotoPerfilUsuario']; }else{echo '../../public/img/Juan-Niebla.png';} ?> /></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../gestionaSubirFoto.php" method="post" enctype="multipart/form-data">
            <?php  
